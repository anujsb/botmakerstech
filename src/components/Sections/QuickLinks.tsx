...
export const QuickLinks = () => {
  return (
    <section className="w-full py-12 md:py-24 lg:py-32 bg-gradient-to-b from-background via-orange-50 to-background flex items-center justify-center">
      <div className="container px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12 items-center justify-center">
