...
export default function AboutPage() {
  const values = [
    { icon: <Rocket className="w-6 h-6" />, title: "Innovation", description: "Constantly developing engaging, hands-on experiences that ignite creativity and curiosity." },
    { icon: <Users className="w-6 h-6" />, title: "Inclusion", description: "Ensuring technology education is accessible to every corner of India, from metropolitan areas to rural communities." },
    { icon: <Shield className="w-6 h-6" />, title: "Integrity", description: "Maintaining transparency, accountability, and trust in all our endeavors." },
    { icon: <Star className="w-6 h-6" />, title: "Excellence", description: "Delivering the highest quality labs, curriculums, and products that inspire and educate." },
    { icon: <Lightbulb className="w-6 h-6" />, title: "Curiosity", description: "Encouraging a mindset of exploration, problem-solving, and lifelong learning." },
    { icon: <Globe className="w-6 h-6" />, title: "Vision", description: "Advancing India's role as a global leader in robotics and technology innovation." },
  ]
    ...
    <div className="bg-[#ffffff] text-[#050315]">
        ...
        <Card className="bg-[#f5f5f5] border-none shadow-lg overflow-hidden">
          <CardContent className="p-8 flex flex-col md:flex-row items-center">
            ...
            <p className="text-lg leading-relaxed md:w-1/2">
              At Botmakers Pvt. Ltd., we're redefining how people engage with technology. Through our Robo Play Zones, where fun meets learning, and InnoTech Academy's hands-on education, we bring robotics, drones, and innovations to life. Our mission is simple: make tech accessible, spark curiosity, and empower the next generation of leaders in India.
            </p>
          </CardContent>
        </Card>
      </motion.section>
        ...
        <div className="container mx-auto px-4">
          ...
          <Card className="bg-white border-none shadow-lg overflow-hidden">
            <CardContent className="p-8 flex flex-col md:flex-row-reverse items-center">
              ...
              <p className="text-lg leading-relaxed md:w-1/2">
                At Botmakers Pvt. Ltd., we spark a passion for technology by blending learning with innovation. Our Robo Play Zones offer fun, hands-on experiences with robotics and drones, while InnoTech Academy integrates emerging tech into education, reaching learners from KG to PG across urban and rural areas. Committed to inclusivity, we empower every student with the tools to shape a tech-driven future and thrive in a world where innovation knows no bounds.
              </p>
            </CardContent>
          </Card>
        </div>
                  ...
                  <div className="flex flex-col md:flex-row h-full">
                    ...
                    <CardContent className="md:w-2/3 p-6 flex flex-col justify-between">
                      <div>
                        ...
                        <Badge variant="secondary" className="mb-4 bg-[#fbdbcb] text-[#ff6101]">{leader.role}</Badge>
      ...
      >
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-4xl font-bold mb-8">Join Us in Shaping the Future</h2>
          <p className="text-xl mb-8">Be part of the innovation journey with Botmakers Pvt. Ltd.</p>
          <motion.button 
